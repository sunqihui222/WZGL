...
public class JobOrderUnCompoundingFragment extends BaseLazyFragment {
    ...
    public static JobOrderUnCompoundingFragment newInstance() {
        return new JobOrderUnCompoundingFragment();
    }
    ...
    private void initData() {
        if (null != BaseApplication.mDepartmentData && !TextUtils.isEmpty(BaseApplication.mDepartmentData.departmentName)) {
            mDepartmentData = new DepartmentData(BaseApplication.mUserInfoData.getDepartId(), BaseApplication.mUserInfoData.getDepartName(), ConstantsUtils.JOBORDERUNCOMPOUNDING);
        ...
        mParametersData.fromTo = ConstantsUtils.JOBORDERUNCOMPOUNDING;
    ...
    public void updateSearch(ParametersData mParametersData) {
        if (mParametersData != null) {
            if (mParametersData.fromTo == ConstantsUtils.JOBORDERUNCOMPOUNDING) {
    ...
    public void updateDepartment(DepartmentData mDepartmentData) {
        if (null != mDepartmentData && null != mParametersData ) {
            if (mDepartmentData.fromto == ConstantsUtils.JOBORDERUNCOMPOUNDING) {
