...
public class JobOrderCompoundingFragment extends BaseLazyFragment {
    ...
    public static JobOrderCompoundingFragment newInstance() {
        return new JobOrderCompoundingFragment();
    }
    ...
    private void initData() {
        if (null != BaseApplication.mDepartmentData && !TextUtils.isEmpty(BaseApplication.mDepartmentData.departmentName)) {
            mDepartmentData = new DepartmentData(BaseApplication.mUserInfoData.getDepartId(), BaseApplication.mUserInfoData.getDepartName(), ConstantsUtils.JOBORDERCOMPOUNDING);
        ...
        mParametersData.fromTo = ConstantsUtils.JOBORDERCOMPOUNDING;
    ...
    public void updateSearch(ParametersData mParametersData) {
        if (mParametersData != null) {
            if (mParametersData.fromTo == ConstantsUtils.JOBORDERCOMPOUNDING) {
    ...
    public void updateDepartment(DepartmentData mDepartmentData) {
        if (null != mDepartmentData && null != mParametersData ) {
            if (mDepartmentData.fromto == ConstantsUtils.JOBORDERCOMPOUNDING) {
