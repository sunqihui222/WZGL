...
public class JobOrderInProductionFragment extends BaseLazyFragment {
    ...
    public static JobOrderInProductionFragment newInstance() {
        return new JobOrderInProductionFragment();
    }
