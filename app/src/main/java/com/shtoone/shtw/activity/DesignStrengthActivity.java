 ...
 */
public class DesignStrengthActivity extends BaseActivity{

    private static final String TAG = DesignStrengthActivity.class.getSimpleName();
    private Toolbar mToolbar;
    private PtrFrameLayout mPtrFrameLayout;
    private RecyclerView mRecyclerView;
    private PageStateLayout mPageStateLayout;
    private Gson mGson;
    private DesignStrengthData data;
    private List<DesignStrengthData.DataBean> listData;
    private LinearLayoutManager mLinearLayoutManager;
    private DesignStrengthActivityRecylerView mAdapter;
    ...
    public String createRefreshULR() {
        ...
        return URL.getDataDictionary("SJQD");
    }
    ...
    public void onRefreshSuccess(String response) {
        if (!TextUtils.isEmpty(response)) {
            ...
            if (jsonObject.optBoolean("success")) {
                data = mGson.fromJson(response, DesignStrengthData.class);
                if (null != data) {
                    if (data.isSuccess()) {
    ...
    public void setAdapter(){
        ...
        //设置动画与适配器
        SlideInLeftAnimationAdapter mSlideInLeftAnimationAdapter = new SlideInLeftAnimationAdapter(mAdapter = new DesignStrengthActivityRecylerView(this, listData));
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("designstrength",listData.get(position).getTypename());
                setResult(33, intent);
                onBackPressed();
            }
        });
