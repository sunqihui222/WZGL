...
public class MaterialConsumeActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialConsumeFragment materialConsumeFragment =  MaterialConsumeFragment.newInstance();
        transaction.add(R.id.root_layout_joborderuncompounding, materialConsumeFragment);
        transaction.commit();
    }
}
