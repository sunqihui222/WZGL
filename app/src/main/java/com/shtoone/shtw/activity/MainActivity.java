...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void initData() {
        ...
        AHBottomNavigationItem item2 = new AHBottomNavigationItem(R.string.laboratory, R.drawable.ic_lab, R.color.material_yellow_100);

        AHBottomNavigationItem item3 = new AHBottomNavigationItem(R.string.weight_house, R.drawable.gbc, R.color.white);
        AHBottomNavigationItem item4 = new AHBottomNavigationItem(R.string.engineering_department, R.drawable.gcb, R.color.material_yellow_100);
        AHBottomNavigationItem item5 = new AHBottomNavigationItem(R.string.storage, R.drawable.ck, R.color.material_yellow_100);
